                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <dl v-for="message in messages" v-bind:key="message.id">
                            ...
                            <dt v-if="message.user.online === true" :class="{  'text-right': message.user.id === username }"><i class="fa fa-circle" style="color: green"></i></dt>
                            <dt v-if="message.user.online === false" :class="{  'text-right': message.user.id === username }"><i class="fa fa-circle" style="color: red"></i></dt>
                            ...
                            <dd :class="{  'text-right': message.user.id === username }">{{ message.created_at | formatDate }}</dd>
                        </dl>
        ...
        async initializeChannel() {
            ...
            this.channel.on("message.new", event => {
                this.messages.push({
                    ...
                    online:event.message.user.online,
